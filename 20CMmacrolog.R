#Crowley-Martin macropar??sitos logistico
library(deSolve)
library(pracma)
...
Pars <- c(gamma = .6, beta = 2, mu = 0.8, m = 1.2, K=10, h=.2, s=.2)
State <- c(p = 1, i = 1)
Time <- seq(0,100, by =1)
...
legend("topleft", "deAngelis-Beddington2", box.lwd =0)
